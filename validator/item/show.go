...
func (v Validator) ValidateShowSingleItem(ctx context.Context, req itemparam.ShowSingleItemRequest) (map[string]string, error) {
	const op = "itemvalidator.ValidateShowSingleItem"
