...
func (v Validator) ValidateRefundPayment(ctx context.Context, req paymentparam.RefundPaymentRequest) (map[string]string, error) {
	const op = "paymentvalidator.ValidateRefundPayment"
